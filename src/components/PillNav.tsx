...
export default function PillNav({
  ...
  ease = "power3.easeOut",
  baseColor = "var(--ink)",
  pillColor = "var(--warm-white)",
  hoveredPillTextColor = "var(--warm-white)",
  pillTextColor,
  onMobileMenuClick,
  ...
  const logoElementRef = useRef<HTMLImageElement | HTMLSpanElement | null>(null);
  ...
  const logoLinkHref = logoHref ?? items?.[0]?.href ?? "#";
  ...
  const handleLogoEnter = () => {
    const el = logoElementRef.current;
    if (!el) return;
