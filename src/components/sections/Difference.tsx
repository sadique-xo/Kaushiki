...
export function Difference({ eyebrow, title, pillars }: DifferenceProps) {
  return (
    <section id="difference" className="bg-[var(--ink)]">
      <div className="mx-auto max-w-[1160px] px-6 py-24 md:px-14">
        ...
        <motion.h2
          ...
          className="mb-16 max-w-[640px] font-serif text-[clamp(36px,4.5vw,62px)] font-light leading-tight text-[var(--warm-white)]"
        ...
        <div className="grid gap-16 md:grid-cols-2">
          ...
          >
            {pillars.map((p) => (
              ...
              >
                <span
                  className="mb-3 block font-serif text-3xl italic leading-none text-[var(--accent)]"
                  style={{ fontFamily: "var(--font-heading)" }}
                >
                  {p.glyph}
                </span>
                <h4 className="mb-2 text-[12px] font-semibold uppercase tracking-[0.07em] text-[var(--warm-white)]">
                  {p.title}
                </h4>
