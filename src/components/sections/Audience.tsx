...
export function Audience({
  ...
  return (
    <section id="audience" className="bg-[var(--ink)]">
      <div className="mx-auto max-w-[1160px] px-6 py-24 md:px-14">
        <div className="grid gap-20 md:grid-cols-[6fr_5fr]">
          ...
          >
            ...
            <h2
              className="font-serif text-[clamp(34px,4.2vw,58px)] font-light leading-tight text-[var(--warm-white)]"
            ...
            <div className="flex flex-wrap gap-2">
              {tags.map((tag) => (
                <span
                  key={tag}
                  className="cursor-default border border-[rgba(255,255,255,0.1)] px-4 py-2 text-[12px] text-[rgba(255,255,255,0.58)] transition-all hover:border-[var(--accent)] hover:bg-[var(--accent)] hover:text-[var(--ink)]"
                >
                  {tag}
                </span>
              ))}
          ...
          >
            {values.map((v) => (
              ...
              >
                <h4
                  className="mb-1 font-serif text-[21px] font-normal text-[var(--warm-white)]"
                  style={{ fontFamily: "var(--font-heading)" }}
                >
                  {v.title}
                </h4>
