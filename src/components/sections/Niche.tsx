...
export function Niche({ eyebrow, title, description, cards }: NicheProps) {
  return (
    <section id="niche" className="bg-[var(--warm-white)]">
      <div className="mx-auto max-w-[1160px] px-6 py-24 md:px-14">
        <div className="mb-14 grid gap-16 md:grid-cols-2 md:items-end">
          ...
          <motion.p
            ...
            className="max-w-[380px] self-end text-[14px] leading-[1.82] text-[var(--muted-color)]"
          >
            {description}
          </motion.p>
        </div>
        <div className="grid gap-0.5 md:grid-cols-2 lg:grid-cols-3">
          {cards.map((card, i) => (
            <motion.div
              ...
              className="group relative overflow-hidden bg-[var(--cream)] p-8 transition-transform hover:-translate-y-1 hover:after:scale-x-100 after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-full after:bg-[var(--accent)] after:origin-left after:scale-x-0 after:transition-transform after:duration-300"
            >
              <span
              ...
              <p className="text-[13px] leading-[1.72] text-[var(--muted-color)]">
                {card.description}
              </p>
            </motion.div>
          ))}
